...
<?php $this->beginPage() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('/imgs/banner/popup-1.png')">
                        <div class="deal-top">
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-2.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-1.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-3.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-4.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-5.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-6.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/imgs/shop/product-16-7.jpg" alt="product image">
                                    </figure>
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    <div><img src="/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-4.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-5.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-6.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-7.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-8.jpg" alt="product image"></div>
                                    <div><img src="/imgs/shop/thumbnail-9.jpg" alt="product image"></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                        </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest"
                                                                                           src="/imgs/shop/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-1.svg" alt="">Milks and
                                                Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-2.svg" alt="">Clothing &
                                                beauty</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-3.svg" alt="">Pet Foods &
                                                Toy</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-4.svg" alt="">Baking
                                                material</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-5.svg" alt="">Fresh Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-6.svg" alt="">Wines &
                                                Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-7.svg" alt="">Fresh
                                                Seafood</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-8.svg" alt="">Fast
                                                food</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                        ...
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                        src="/imgs/theme/icons/category-10.svg" alt="">Bread and
                                                Juice</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                            src="/imgs/theme/icons/icon-1.svg" alt="">Milks and
                                                    Dairies</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                            src="/imgs/theme/icons/icon-2.svg" alt="">Clothing &
                                                    beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                            src="/imgs/theme/icons/icon-3.svg" alt="">Wines &
                                                    Drinks</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                            src="/imgs/theme/icons/icon-4.svg" alt="">Fresh
                                                    Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img
                                                                src="/imgs/banner/banner-menu.png" alt="Nest"></a>
                ...
                <div class="home-slide-cover mt-30">
                    <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                        <div class="single-hero-slider single-animation-wrap"
                             style="background-image: url(/imgs/slider/slider-1.png)">
                        ...
                        <div class="single-hero-slider single-animation-wrap"
                             style="background-image: url(/imgs/slider/slider-2.png)">
                            <div class="slider-content">
                                <h1 class="display-2 mb-40">
                                    Fresh Vegetables<br>
                                    Big discount
                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-13.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-12.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-11.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-9.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-3.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-1.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-2.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-4.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-5.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-14.png" alt=""></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="/imgs/shop/cat-15.png" alt=""></a>
                            </figure>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-1-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-1-2.jpg" alt="">
                                            </a>
                                        </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-2-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-2-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-3-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-3-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-4-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-4-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-5-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-5-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-7-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-7-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-8-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-8-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-9-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-9-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                                <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-10-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-10-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-12-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-12-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-13-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-13-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-14-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-14-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-15-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-15-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-16-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-16-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/imgs/shop/product-11-1.jpg" alt="">
                                                <img class="hover-img" src="/imgs/shop/product-11-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-1-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-1-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-5-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-5-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-2-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-2-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-3-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-3-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-4-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-4-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-2">
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-10-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-10-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-15-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-15-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-12-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-12-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-13-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-13-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-14-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-14-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-3">
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-7-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-7-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-8-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-8-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img" src="/imgs/shop/product-9-1.jpg"
                                                             alt="">
                                                        <img class="hover-img" src="/imgs/shop/product-9-2.jpg"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                ...
                <div class="row">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-1.jpg"
                                                                           alt=""></a>
                                </figure>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-2.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-3.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-4.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-5.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-6.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-7.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-8.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-9.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-10.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-11.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="/imgs/shop/thumbnail-12.jpg"
                                                                           alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
    ...
    <footer class="main">
        <?= $this->render("footer-newsletter"); ?>
        <?= $this->render("footer-featured"); ?>
        <?= $this->render("footer-section"); ?>
        <?= $this->render("footer-container"); ?>
    </footer>
    <!-- Preloader Start -->
